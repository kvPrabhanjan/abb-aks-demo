resource "azurerm_key_vault" "aks_store" {
...
#   key_vault_id = azurerm_key_vault.aks_store[0].id
#   depends_on   = [azurerm_role_assignment.akv_rbac]
# }
